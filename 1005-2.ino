...
void Dot () {ledcWriteTone(channel, 1000);ledcWrite(channel, 255); delay (shortLightTime); ledcWrite(channel, 0); delay (codeSpaceTime);}
void Dash () {ledcWriteTone(channel, 1000);ledcWrite(channel, 255); delay (longLightTime); ledcWrite(channel, 0);  delay (codeSpaceTime);}
